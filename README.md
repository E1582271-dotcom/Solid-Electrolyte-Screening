...
*Full pipeline diagram lives in the flagship repo: [Solid-Electrolyte-MLIP-MD/figures/08_pipeline_overview.png](https://github.com/E1582271-dotcom/Solid-Electrolyte-MLIP-MD/blob/main/figures/08_pipeline_overview.png) (generated by [`08_pipeline_overview.py`](https://github.com/E1582271-dotcom/Solid-Electrolyte-MLIP-MD/blob/main/08_pipeline_overview.py)). This repo is **Project 1 (screen)** in that diagram — its two funnel leads (Li₂₀Si₃P₃S₂₃Cl, Li₈TiS₆) get MLIP-MD-validated in [Solid-Electrolyte-MLIP-MD](https://github.com/E1582271-dotcom/Solid-Electrolyte-MLIP-MD).*
